...
class OASISSRDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if self.opt['val'] == False:
            self.movedfilenames = self.movedfilenames[:300]
            self.fixedfilenames = self.fixedfilenames[:300]
        else:
    ...
    def __getitem__(self, index):
        ...
        down_img1 = zoom(down_img1,(1,8,8), order=2,mode='reflect')
       
        return {'lq': down_img1, 'gt': img2, 'gt_path': str(casenum), 'lq_path': str(casenum)}
